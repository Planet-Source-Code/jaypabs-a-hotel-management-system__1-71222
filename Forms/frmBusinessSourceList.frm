...
Begin VB.Form frmBusinessSourceList 
   ...
   End
End
Attribute VB_Name = "frmBusinessSourceList"
...
Dim rsBusinessSource As New Recordset
    ...
    Select Case srcPerformWhat
        ...
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("[Business Source]", "BusinessSourceID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Business Source", "BusinessSourceID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "BusinessSource,BusinessSourceID"
        .Tables = "[Business Source]"
        .SortOrder = "BusinessSource ASC"
        
        .SaveStatement
    End With
    
    rsBusinessSource.CursorLocation = adUseClient
    rsBusinessSource.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsBusinessSource, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsBusinessSource, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "BusinessSourceID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmBusinessSourceList = Nothing
End Sub
