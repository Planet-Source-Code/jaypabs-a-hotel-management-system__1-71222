...
Begin VB.Form frmVehiclesList 
   ...
   End
End
Attribute VB_Name = "frmVehiclesList"
...
Dim rsVehicle As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmVehicles.State = adStateAddMode
            frmVehicles.Show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("[Vehicles]", "VehicleID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Vehicles", "VehicleID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        ...
        .Tables = "[Vehicles]"
        .SortOrder = "Vehicle ASC"
        
        .SaveStatement
    End With
    
    rsVehicle.CursorLocation = adUseClient
    rsVehicle.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsVehicle, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "VehicleID")
    Me.Enabled = True
