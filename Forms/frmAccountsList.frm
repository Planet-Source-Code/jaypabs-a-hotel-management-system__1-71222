...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmAccounts.State = adStateAddMode
            frmAccounts.Show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Accounts", "AccountCode", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                ...
                Else
                    With frmAccounts
                        ...
                        AccountCode = CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        
                        blnLocked = getValueAt("SELECT Locked FROM Accounts WHERE AccountCode='" & AccountCode & "'", "Locked")
                        ...
                        CN.Execute "UPDATE Accounts SET Locked = True WHERE AccountCode = '" & AccountCode & "'"
                    
                        .State = adStateEditMode
                        .PK = AccountCode
                        .Show vbModal
                        
                        CN.Execute "UPDATE Accounts SET Locked = False WHERE AccountCode = '" & AccountCode & "'"
                    End With
                End If
            End If
        Case "Search"
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Accounts", "AccountCode", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
        ...
        Case "Print"
            With mdiMain.CR
                .Reset: mdiMain.InitCrys
                .ReportFileName = App.Path & "\Reports\rpt_Customers_Profile.rpt"
                
                .WindowTitle = "Customer Profile"
        
                .ParameterFields(0) = "prmBusName;" & CurrBiz.BUSINESS_NAME & ";True"
...
Private Sub Form_Activate()
    HighlightInWin Me.Name: mdiMain.ShowTBButton "", True
End Sub
...
'    mdiMain.AddToWin Me.Caption, Name
    ...
    With SQLParser
        .Fields = "[Name], [Position], SecLevel, UserName, AccountCode"
        .Tables = "Accounts"
        .SortOrder = "Name ASC"
    ...
    Debug.Print CN
    rsAccounts.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsAccounts, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "AccountCode")
    Me.Enabled = True
