...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmCompany.State = adStateAddMode
            frmCompany.Show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("[Company]", "CompanyID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Company", "CompanyID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Company,LastName,FirstName,Address,EmailAddress,TelNo,MobileNo,FaxNo,CompanyID"
        .Tables = "[Company]"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsCompany, RecordPage.PageStart, RecordPage.PageEnd, 8, 2, False, True, , , , "CompanyID")
    Me.Enabled = True
