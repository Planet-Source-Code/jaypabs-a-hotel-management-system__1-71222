...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmCustomers.State = adStateAddMode
            frmCustomers.Show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("[Customers]", "CustomerID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Customers", "CustomerID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "LastName,FirstName,Address,EmailAddress,TelNo,MobileNo,FaxNo,CustomerID"
        .Tables = "[Customers]"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsCustomers, RecordPage.PageStart, RecordPage.PageEnd, 8, 2, False, True, , , , "CustomerID")
    Me.Enabled = True
