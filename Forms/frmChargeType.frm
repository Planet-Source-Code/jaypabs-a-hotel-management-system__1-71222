...
Begin VB.Form frmChargeType 
   ...
   End
End
Attribute VB_Name = "frmChargeType"
...
Private Sub DisplayForEditing()
    ...
    With RS
        txtEntry.Text = .Fields("ChargeType")
    End With
...
Private Sub cmdSave_Click()
    ...
    'Phill 2:12
    With RS
        .Fields("ChargeType") = txtEntry.Text
...
Private Sub Form_Load()
    ...
    RS.Open "SELECT * FROM [Charge Type] WHERE ChargeTypeID = " & PK, CN, adOpenStatic, adLockOptimistic
...
Private Sub Form_Unload(Cancel As Integer)
    If HaveAction = True Then
        If State = adStateAddMode Or adStateEditMode Then
            frmChargeTypeList.RefreshRecords
        End If
    End If
    
    Set frmChargeType = Nothing
End Sub
