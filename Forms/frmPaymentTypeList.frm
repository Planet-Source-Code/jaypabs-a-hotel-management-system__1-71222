...
Begin VB.Form frmPaymentTypeList 
   ...
   End
End
Attribute VB_Name = "frmPaymentTypeList"
...
Dim rsPaymentType As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmPaymentType.State = adStateAddMode
            frmPaymentType.Show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("[Payment Type]", "PaymentTypeID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Payment Type", "PaymentTypeID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "PaymentType,PaymentTypeID"
        .Tables = "[Payment Type]"
        .SortOrder = "PaymentType ASC"
        
        .SaveStatement
    End With
    
    rsPaymentType.CursorLocation = adUseClient
    rsPaymentType.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsPaymentType, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsPaymentType, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "PaymentTypeID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmPaymentTypeList = Nothing
End Sub
