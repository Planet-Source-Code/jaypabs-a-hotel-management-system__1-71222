...
Begin VB.Form frmRoomsWindow 
   ...
   End
End
Attribute VB_Name = "frmRoomsWindow"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    If srcPerformWhat = "Edit" Then
        If lvList.SelectedItem.SubItems(2) = "Vacant" Then
            srcPerformWhat = "New"
        ElseIf lvList.SelectedItem.SubItems(2) = "Occupied" Then
            srcPerformWhat = "Edit"
        End If
    End If
    ...
    Select Case srcPerformWhat
        Case "New"
            frmCheckIn.State = adStateAddMode
            frmCheckIn.Room = CLng(LeftSplitUF(lvList.SelectedItem.Tag))
