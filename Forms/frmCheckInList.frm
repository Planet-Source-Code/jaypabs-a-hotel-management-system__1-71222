...
Begin VB.Form frmCheckInList 
   ...
   End
End
Attribute VB_Name = "frmCheckInList"
...
Dim rsTransactions As New Recordset
    ...
    Select Case srcPerformWhat
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Transactions", "FolioNumber", LeftSplitUF(lvList.SelectedItem.Tag), True) = False Then
                ...
                Else
                    With frmCheckIn
                        ...
                        FolioNumber = LeftSplitUF(lvList.SelectedItem.Tag)
                        
                        .State = adStatePopupMode
                        .PK = lvList.SelectedItem.SubItems(1)
                        .PopupPK = FolioNumber
                        .Show vbModal
                    End With
                End If
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Transactions", "FolioNumber", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "This record has been removed by other user.Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Transactions", "FolioNumber", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Activate()
    HighlightInWin Me.Name: mdiMain.ShowTBButton "fftfttt"
End Sub
...
'    mdiMain.AddToWin Me.Caption, Name
    ...
    With SQLParser
        .Fields = "[Name], RoomNumber, DateIn, DateOut, FolioNumber"
        .Tables = "qry_CheckIn"
        .wCondition = "Status = 'Check Out'"
        .SortOrder = "Name ASC"
        
        .SaveStatement
    End With
    
    If rsTransactions.State = 1 Then rsTransactions.Close
    rsTransactions.CursorLocation = adUseClient
    Debug.Print CN
    rsTransactions.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsTransactions, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsTransactions, RecordPage.PageStart, RecordPage.PageEnd, 15, 2, False, True, , , , "FolioNumber")
    Me.Enabled = True
