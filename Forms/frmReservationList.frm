...
Begin VB.Form frmReservationList 
   Caption         =   "Reservation"
   ClientHeight    =   7095
   ClientLeft      =   60
   ClientTop       =   345
   ...
   End
End
Attribute VB_Name = "frmReservationList"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmReservation.State = adStateAddMode
            frmReservation.Show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Reservation", "ReservationNo", LeftSplitUF(lvList.SelectedItem.Tag), True) = False Then
                ...
                Else
                    With frmReservation
                        ...
                        .PK = LeftSplitUF(lvList.SelectedItem.Tag)
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Reservation", "ReservationNo", CLng(LeftSplitUF(lvList.SelectedItem.Tag)), True) = False Then
                    MsgBox "This record has been removed by other user.Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
