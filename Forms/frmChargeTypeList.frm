...
Begin VB.Form frmChargeTypeList 
   Caption         =   "Charge Type"
   ClientHeight    =   6330
   ClientLeft      =   60
   ClientTop       =   345
   ...
   End
End
Attribute VB_Name = "frmChargeTypeList"
...
Dim rsChargeType As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmChargeType.State = adStateAddMode
            frmChargeType.Show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("[Charge Type]", "ChargeTypeID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Charge Type", "ChargeTypeID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "ChargeType,ChargeTypeID"
        .Tables = "[Charge Type]"
        .SortOrder = "ChargeType ASC"
        
        .SaveStatement
    End With
    
    rsChargeType.CursorLocation = adUseClient
    rsChargeType.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsChargeType, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsChargeType, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "ChargeTypeID")
    Me.Enabled = True
