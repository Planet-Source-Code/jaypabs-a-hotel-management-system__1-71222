...
Begin VB.Form frmRateTypeList 
   ...
   End
End
Attribute VB_Name = "frmRateTypeList"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmRateType.State = adStateAddMode
            frmRateType.Show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("[Rate Type]", "RateTypeID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "[Rate Type]", "RateTypeID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "RateType,RateTypeID"
        .Tables = "[Rate Type]"
        .SortOrder = "RateType ASC"
        
        .SaveStatement
    End With
    
    rsRateType.CursorLocation = adUseClient
    rsRateType.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsRateType, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "RateTypeID")
    Me.Enabled = True
