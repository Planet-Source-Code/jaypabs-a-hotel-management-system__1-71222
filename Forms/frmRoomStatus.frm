...
Private Sub Form_Load()
    ...
    RS.Open "SELECT * FROM [Room Status] WHERE StatusID = " & PK, CN, adOpenStatic, adLockOptimistic
...
Private Sub Form_Unload(Cancel As Integer)
    If HaveAction = True Then
        If State = adStateAddMode Or adStateEditMode Then
            frmRoomStatusList.RefreshRecords
        End If
    End If
    
    Set frmRoomStatus = Nothing
End Sub
