...
Begin VB.Form frmIDTypeList 
   ...
   End
End
Attribute VB_Name = "frmIDTypeList"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmIDType.State = adStateAddMode
            frmIDType.Show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("[ID Type]", "IDTypeID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Countries", "IDTypeID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "IDType,IDTypeID"
        .Tables = "[ID Type]"
        .SortOrder = "IDType ASC"
        
        .SaveStatement
    End With
    
    rsIDType.CursorLocation = adUseClient
    rsIDType.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsIDType, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "IDTypeID")
    Me.Enabled = True
