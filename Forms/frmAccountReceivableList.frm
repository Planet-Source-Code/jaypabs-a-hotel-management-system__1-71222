...
Begin VB.Form frmAccountReceivableList 
   ...
   End
End
Attribute VB_Name = "frmAccountReceivableList"
    ...
    Select Case srcPerformWhat
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("[Accounts Receivable]", "AccRecID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "This record has been removed by other user.Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    With frmAccountReceivable
                        .PK = CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        .Company = lvList.SelectedItem
                        .AmountPaid = lvList.SelectedItem.SubItems(3)
                        .Balance = lvList.SelectedItem.SubItems(4)
                        .Show vbModal
                    End With
                End If
            End If
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Accounts Receivable", "AccRecID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Company,FolioNumber,Total,AmountPaid,Balance,AccRecID"
        .Tables = "[qry_Account_Receivable]"
        .SortOrder = "Company ASC"
        
        .SaveStatement
    End With
    
    rsAccRec.CursorLocation = adUseClient
    rsAccRec.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsAccRec, RecordPage.PageStart, RecordPage.PageEnd, 5, 2, False, True, , , , "AccRecID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmAccountReceivableList = Nothing
End Sub
